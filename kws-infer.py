...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="https://github.com/Kaldr4/Deep-Learning-Assignment-3/releases/tag/kws-best-acc.pt")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        mel = ToTensor()(librosa.power_to_db(transform(waveform).squeeze().numpy(), ref=np.max))
        mels_arr = einops.rearrange(mel, 'c h (p w) -> p (c h w)', p = 8)
        mel = mel.unsqueeze(0)
